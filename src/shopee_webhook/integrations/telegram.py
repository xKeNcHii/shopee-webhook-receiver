...
class TelegramNotifier:
    ...
    def _create_topic(self, event_code: int) -> Optional[int]:
        ...
        try:
            ...
            response = requests.post(self.api_url_topic, json=payload, timeout=5)
    ...
    def format_webhook_message(
        ...
        event_names = {
            ...
            25: "Booking Shipping Document Status",
        }
    ...
    def send_event(
        ...
        """
        Send webhook event to Telegram.
        ...
        try:
            ...
            for idx, chunk in enumerate(message_chunks, 1):
                ...
                response = requests.post(self.api_url_send, json=payload, timeout=5)
